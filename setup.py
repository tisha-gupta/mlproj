...
#find_packages --this will automatically find ut all the packages that are available 
# in the entire ML algorithm, in the directory that we have actually created 
...
setup(
    ...
    #we 1st passed install_requires = [pandas, numpy, seaborn] -- we can do this also
    #but by writing get_requirements('requirements.txt) -- it will take the packages mentioned in the requirements.txt
